...
@Entity
@Table(name = "viewReservaCancelada")
@Subselect("SELECT r.* FROM reserva r WHERE id_reserva IN (SELECT id_reserva FROM pago GROUP BY id_reserva HAVING SUM(valor)< (AVG(pago_total)*0.2));")
public class ViewReservaCanceladaDTO {
    @Id
    ...
    public ViewReservaCanceladaDTO(){
    }
    ...
    public boolean equals(Object o) {
        ...
        ViewReservaCanceladaDTO that = (ViewReservaCanceladaDTO) o;
    ...
    public String toString() {
        return "ViewReservaCanceladaDTO{" +
